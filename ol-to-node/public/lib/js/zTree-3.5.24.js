    ...
    var I,
                    ...
                    c[f] && c[f].length > 0
                        ...
                        : ((c.isParent =
                              typeof c.isParent == "string"
                                  ...
                                  : !!c.isParent),
                          (c.open =
                              c.isParent && !b.async.enable ? c.open : !1),
                          (c.zAsync = !c.isParent));
                    c.isFirstNode = e;
                    c.isLastNode = g;
            ...
            function (b) {
                ...
                if (j.eqs(b.type, "mousedown")) m = "mousedown";
                    ...
                    if (
                        ...
                        if (
                            (k = j.getMDom(c, a, [
                                { tagName: "a", attrName: "treeNode" + f.id.A },
                            ]))
                        )
        ...
        h = {
            ...
            addNodesData: function (b, a, c, d) {
                ...
                c < 0
                    ? (a[e] = a[e].concat(d))
                    : ((b = [c, 0].concat(d)), a[e].splice.apply(a[e], b));
            },
            ...
            getNodeByParam: function (b, a, c, d) {
                if (!a || !c) return null;
                for (
                    var e = b.data.key.children, g = 0, f = a.length;
                    g < f;
                    g++
                ) {
            ...
            getNodePath: function (b, a) {
                if (!a) return null;
                var c;
                (c = a.parentTId ? a.getParentNode().getPath() : []) &&
                    c.push(a);
                return c;
            },
            ...
            getNodesByParam: function (b, a, c, d) {
                if (!a || !c) return [];
                for (
                    var e = b.data.key.children, g = [], f = 0, i = a.length;
                    f < i;
                    f++
                )
                    a[f][c] == d && g.push(a[f]),
            ...
            getNodesByParamFuzzy: function (b, a, c, d) {
                ...
                for (
                    ...
                    typeof a[f][c] == "string" &&
                        ...
                        g.push(a[f]),
                        (g = g.concat(
                            h.getNodesByParamFuzzy(b, a[f][e], c, d)
                        ));
                return g;
            },
            ...
            isSelectedNode: function (b, a) {
                for (
                    var c = h.getRoot(b), d = 0, e = c.curSelectedList.length;
                    d < e;
                    d++
                )
                ...
                for (
                    ...
                    if (
                        ...
                        c.curSelectedList.splice(d, 1),
                            b.treeObj.trigger(f.event.UNSELECTED, [
                                b.treeId,
                                a,
                            ]),
                            d--,
                ...
                if (j.isArray(a))
                    for (var e = 0, g = a.length; e < g; e++)
                        d.push(a[e]),
                            a[e][c] &&
                                (d = d.concat(
                                    h.transformToArrayFormat(b, a[e][c])
                                ));
                else
                    d.push(a),
                        a[c] &&
        ...
        l = {
            ...
            unbindTree: function (b) {
                b.treeObj
                    .unbind("selectstart", v)
                    .unbind("click", l.proxy)
                    .unbind("dblclick", l.proxy)
                    .unbind("mouseover", l.proxy)
            ...
            proxy: function (b) {
                ...
                for (
                    var a = l.doProxy(b), c = !0, d = 0, e = a.length;
                    d < e;
                    d++
                ) {
                    var g = a[d];
    ...
    var j = {
            ...
            $: function (b, a, c) {
                ...
                return typeof b == "string"
                    ? q(b, c ? c.treeObj.get(0).ownerDocument : null)
                    : q("#" + b.tId + a, c ? c.treeObj : null);
            },
        ...
        i = {
            addNodes: function (b, a, c, d, e) {
                if (!b.data.keep.leaf || !a || a.isParent)
                    if (
                        (j.isArray(d) || (d = [d]),
                        b.data.simpleData.enable &&
                            (d = h.transformTozTreeFormat(b, d)),
                        a)
                    ) {
            ...
            asyncNode: function (b, a, c, d) {
                ...
                if (a && !a.isParent) return j.apply(d), !1;
                    ...
                    j.apply(b.callback.beforeAsync, [b.treeId, a], !0) == !1
                )
                    return j.apply(d), !1;
                if (a)
                    (a.isAjaxing = !0),
            ...
            cancelPreSelectedNode: function (b, a, c) {
                ...
                for (e = d.length - 1; e >= 0; e--)
                    if (((g = d[e]), a === g || (!a && (!c || c !== g))))
                        if (
                            (k(g, f.id.A, b).removeClass(f.node.CURSELECTED), a)
                        ) {
            ...
            expandCollapseNode: function (b, a, c, d, e) {
                ...
                if (a) {
                    if (g.expandTriggerFlag)
                        (o = e),
                            (e = function () {
                                o && o();
                                a.open
                                    ? b.treeObj.trigger(f.event.EXPAND, [
                                          b.treeId,
                                          a,
                                      ])
                                    : b.treeObj.trigger(f.event.COLLAPSE, [
                                          b.treeId,
                                          a,
                                      ]);
                            }),
                    ...
                    if (
                        ...
                        a.isParent &&
                        (!k(a, f.id.UL, b).get(0) ||
                            (a[m] && a[m].length > 0 && !k(a[m][0], b).get(0)))
                    )
                    ...
                    if (a.open == c) j.apply(e, []);
                        ...
                        a.isParent
                            ? ((a.open = !a.open),
                              ...
                              a.open
                                  ? (i.replaceSwitchClass(a, g, f.folder.OPEN),
                                    i.replaceIcoClass(a, n, f.folder.OPEN),
                                    d == !1 || b.view.expandSpeed == ""
                                        ? (c.show(), j.apply(e, []))
                                        : a[m] && a[m].length > 0
                                        ? c.slideDown(b.view.expandSpeed, e)
                                        : (c.show(), j.apply(e, [])))
                                  : (i.replaceSwitchClass(a, g, f.folder.CLOSE),
                                    ...
                                    !(a[m] && a[m].length > 0)
                                        ? (c.hide(), j.apply(e, []))
                                        : c.slideUp(b.view.expandSpeed, e)))
                            : j.apply(e, []);
                    }
                } else j.apply(e, []);
            },
            ...
            makeNodeLineClass: function (b, a) {
                ...
                b.view.showLine
                    ? a.level == 0 && a.isFirstNode && a.isLastNode
                        ...
                        : c.push(f.line.CENTER)
                    : c.push(f.line.NOLINE);
                a.isParent
                    ? c.push(a.open ? f.folder.OPEN : f.folder.CLOSE)
                    : c.push(f.folder.DOCU);
            ...
            removeNode: function (b, a) {
                ...
                if (h.getNodeCache(b, a.tId)) {
                    ...
                    if (!b.data.keep.parent && g == 0)
                        ...
                        e == c
                            ? e[d].length == 1
                                ? i.replaceSwitchClass(n, j, f.line.ROOT)
                                : ((c = k(e[d][0], f.id.SWITCH, b)),
                                  i.replaceSwitchClass(
                                      e[d][0],
                                      c,
                                      f.line.ROOTS
                                  ),
                                  i.replaceSwitchClass(n, j, f.line.BOTTOM))
                            : i.replaceSwitchClass(n, j, f.line.BOTTOM);
            ...
            c = {
                ...
                expandNode: function (a, b, c, f, n) {
                    ...
                    if (
                        (n = !!n) &&
                        b &&
                        j.apply(d.callback.beforeExpand, [d.treeId, a], !0) ==
                            !1
                    )
                        return null;
                    else if (
                        n &&
                        !b &&
                        j.apply(d.callback.beforeCollapse, [d.treeId, a], !0) ==
                            !1
                    )
                        return null;
                    b &&
                    ...
                    !j.canAsync(d, a) && c
                        ? i.expandCollapseSonNode(d, a, b, !0, l)
                        : ((a.open = !b), i.switchNode(this.setting, a), l());
                    return b;
                },
                getNodes: function () {
                    return h.getNodes(d);
                ...
                removeNode: function (a, b) {
                    a &&
                        ...
                        (b &&
                            j.apply(
                                d.callback.beforeRemove,
                                [d.treeId, a],
                                !0
                            ) == !1) ||
                            (i.removeNode(d, a),
                            b &&
                                this.setting.treeObj.trigger(f.event.REMOVE, [
                                    d.treeId,
                                    a,
                                ])));
                },
...
(function (m) {
        ...
        view: {
            ...
            setParentNodeCheckBox: function (c, a, b, d) {
                ...
                if (a.parentTId) {
                    ...
                    if (!b)
                        for (
                            var h = a.getParentNode()[h], f = 0, k = h.length;
                            f < k;
                            f++
                        )
                            if (
                ...
                if (a) {
                    ...
                    if (a != g.getRoot(c) && a.chkDisabled !== !0) {
                        ...
                        c.check.autoCheckTrigger &&
                            ...
                            a.nocheck !== !0 &&
                            a.chkDisabled !== !0 &&
                            c.treeObj.trigger(j.event.CHECK, [
                                null,
                                c.treeId,
                                a,
                            ]);
    ...
    g.addInitNode(function (c, a, b, d) {
        if (b) {
            ...
            b.chkDisabled =
                !!b.chkDisabled ||
                (c.check.chkDisabledInherit && d && !!d.chkDisabled);
    ...
    g.addZTreeTools(function (c, a) {
        ...
        a.getCheckedNodes = function (a) {
            var b = this.setting.data.key.children;
            return g.getTreeCheckedNodes(
                this.setting,
                g.getRoot(this.setting)[b],
                a !== !1
            );
        };
        a.getChangeCheckedNodes = function () {
            var a = this.setting.data.key.children;
            return g.getTreeChangeCheckedNodes(
                this.setting,
                g.getRoot(this.setting)[a]
            );
        };
...
(function (v) {
        ...
        x = {
            ...
            onMousedownNode: function (b, a) {
                function c(b) {
                    ...
                    if (B.dragFlag == 0) {
                        if (
                            g.apply(e.callback.beforeDrag, [e.treeId, l], !0) ==
                            !1
                        )
                            return r(b), !0;
                    ...
                    if (B.dragFlag == 1) {
                        ...
                        u &&
                        b.clientX + G.scrollLeft() + 2 >
                            v("#" + u + d.id.A, s).offset().left
                            ? ((n = v("#" + u + d.id.A, s)),
                        ...
                        i =
                            c < e.edit.drag.borderMax &&
                            c > e.edit.drag.borderMin;
                        var j =
                                p < e.edit.drag.borderMax &&
                                p > e.edit.drag.borderMin,
                            F =
                                q < e.edit.drag.borderMax &&
                                q > e.edit.drag.borderMin,
                            x =
                                H < e.edit.drag.borderMax &&
                                H > e.edit.drag.borderMin,
                            p =
                                c > e.edit.drag.borderMin &&
                                p > e.edit.drag.borderMin &&
                                q > e.edit.drag.borderMin &&
                        ...
                        if (p && g.isChildOrSelf(b.target, h.treeId)) {
                            if (
                                !s &&
                                (b.target.id == h.treeId || q || H || N || Q) &&
                                (K || (!K && n.parentTId))
                            )
                                s = h.treeObj;
                            i
                                ? h.treeObj.scrollTop(
                                      h.treeObj.scrollTop() - 10
                                  )
                                : j &&
                                  h.treeObj.scrollTop(
                                      h.treeObj.scrollTop() + 10
                        ...
                        if (s && s.attr("id") != h.treeId) {
                            ...
                            if (!n && !k && !i) j();
                                ...
                                (H == 1 || (y <= H && y >= -0.2)) && n
                                    ...
                                    ? ((a = 1 - A.width()),
                                      (c =
                                          x == null || (z.isParent && z.open)
                                              ? p + F.height() - A.height() / 2
                                              : x.offset().top -
                                                A.height() / 2),
                                      (w = d.move.TYPE_NEXT))
                                    : i
                    ...
                    if (B.dragFlag != 0) {
                        ...
                        if (s) {
                            ...
                            if (
                                ...
                                w == d.move.TYPE_INNER && g.canAsync(h, q)
                                    ? f.asyncNode(h, q, !1, a)
                                    : a();
                            }
                        } else
    ...
    v.extend(!0, v.fn.zTree._z, {
        tools: {
            ...
            inputFocus: function (b) {
                b.get(0) &&
                    (b.focus(), g.setCursorPosition(b.get(0), b.val().length));
            },
            ...
            showIfameMask: function (b, a) {
                ...
                if (a)
                    for (
                        var d = o("iframe", b), f = 0, i = d.length;
                        f < i;
                        f++
                    ) {
                        var j = d.get(f),
        ...
        view: {
            ...
            addHoverDom: function (b, a) {
                if (m.getRoots().showHoverDom)
                    (a.isHover = !0),
                        b.edit.enable &&
                            (f.addEditBtn(b, a), f.addRemoveBtn(b, a)),
            ...
            moveNode: function (b, a, c, r, k, i) {
                ...
                if (
                    ...
                    q.get(0)
                        ? t.get(0) || q.remove()
                        : (q = f
                              .appendNodes(b, c.level, [c], null, -1, !1, !0)
                              .join(""));
                    ...
                    i ||
                        f.expandCollapseParentNode(b, c.getParentNode(), !0, k);
                }
            },
            ...
            k == d.move.TYPE_INNER
                ? ((b = function () {
                  ...
                  g.canAsync(this.setting, a)
                      ...
                      : b())
                : (f.addNodes(this.setting, a.parentNode, -1, [e], i),
    ...
    f.cancelPreSelectedNode = function (b, a) {
        for (
            var c = m.getRoot(b).curSelectedList, d = 0, g = c.length;
            d < g;
            d++
        )
