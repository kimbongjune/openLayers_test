(function () {
    ...
    (postcodeUtils.param = (function (a) {
        ...
        (postcodeUtils.isMobileChrome = function (a) {
            for (
                var b = ["crios", "chrome"], c = 0, d = 0, e = b.length;
                d < e;
                d++
            )
                a.indexOf(b[d]) > -1 && c++;
        ...
        (postcodeUtils.themeStringify = function (a) {
            ...
            try {
                if (a) {
                    ...
                    return (
                        (e = e.substr(0, e.length - 1)), encodeURIComponent(e)
                    );
                }
            } catch (k) {
                return "";
        ...
        (a.CONT = {
            ...
            (a.viewUtils = (function () {
                function b(a, b, d, e, f, h) {
                    ...
                    c.postMessage
                        ? "msie" !== g.browser.name ||
                          ...
                          c.postMessage ||
                          ((h += 60),
                          (a.document.getElementById(e).style.height =
                              h - 4 + "px"),
                ...
                function h(a) {
                    if (a) {
                        ...
                        f.event.isTouch
                            ...
                            : (b.overflow = "hidden"),
                            (a.style.cssText = f.getStringByOptions(
                                b,
                                ":",
                                ";"
                            ));
                ...
                function n(a, b) {
                    if (q.POPUP_MAP[a])
                        for (
                            var c = q.POPUP_MAP[a], d = 0, e = c.length;
                            d < e;
                            d++
                        )
                ...
                function o(a) {
                    for (var b in q.POPUP_MAP)
                        if (q.POPUP_MAP.hasOwnProperty(b))
                            for (
                                var c = q.POPUP_MAP[b], d = 0, e = c.length;
                                d < e;
                                d++
                            )
                ...
                function p(a) {
                    var b =
                        ("msie" === f.userAgent.browser.name &&
                            7 ===
                                parseInt(
                                    f.userAgent.browser.version.major,
                                    10
                                )) ||
                        ("msie" === f.userAgent.browser.name &&
                            10 ===
        ...
        a.frame = (function () {
                ...
                return (
                    (c = f.userAgent.os.ios
                        ? parseInt(f.userAgent.browser.version.major, 10) >= 13
                            ? {
                                  position: "relative",
                                  width: a.isFlexibleWidth
                                      ? a.width
                                      : a.width + "px",
                                  height: a.isFlexibleHeight
                                      ? a.height
                                      : a.height + "px",
            ...
            function l(a) {
                ...
                if (
                    ...
                    var k = f.isAndroidNaverWebview(f.userAgent.ua_string)
                        ? 500
                        : 300;
                    setTimeout(function () {
                        m(e, a), o(e, a);
            ...
            function n(a) {
                ...
                if (d)
                    for (
                        var e = c.getElementsByTagName("iframe"),
                            f = 0,
                            g = e.length;
                        f < g;
                        f++
            ...
            var p = null,
                ...
                s = function (a) {
                    var b = {
                        ...
                        c = {
                            ...
                            a51:
                                f.userAgent.os.android &&
                                f.isAndroidWebview(f.userAgent.ua_string) &&
                                f.userAgent.ua_string.indexOf("android 5.1") >
                                    -1
                                    ? "on"
                                    : "off",
                        };
                    ...
                    var d = p + "&" + f.getStringByOptions(c, "=", "&"),
                        e =
                            "&" +
                            f.getStringByOptions({ fullpath: q }, "=", "&"),
                        g =
                            "&" +
                            f.getStringByOptions({ fullpath: q + r }, "=", "&"),
                        i =
        ...
        function l(a) {
            ...
            if (
                ...
                c.onSearch !== p.EMPTY_FUNCTION
                    ...
                    : ((c.onSearch = p.EMPTY_FUNCTION),
                      (c.onsearch = p.EMPTY_FUNCTION)),
                "boolean" != typeof c.autoMappingJibun &&
                    (c.autoMappingJibun = !0),
                "boolean" != typeof c.autoMappingRoad &&
                    (c.autoMappingRoad = !0),
                ...
                "boolean" != typeof c.autoHiddenSuggest &&
                    (c.autoHiddenSuggest = !1),
                ...
                "number" != typeof c.pleaseReadGuideTimer
                    ...
                    : ((c.pleaseReadGuideTimer = parseFloat(
                          c.pleaseReadGuideTimer
                      )),
                      c.pleaseReadGuideTimer <= 0 &&
                          (c.pleaseReadGuideTimer = 1.5),
                      c.pleaseReadGuideTimer > 60 &&
                          (c.pleaseReadGuideTimer = 1.5)),
                isNaN(c.maxSuggestItems) || "number" != typeof c.maxSuggestItems
                    ...
                    : ((c.maxSuggestItems = parseInt(c.maxSuggestItems, 10)),
                      (c.maxSuggestItems < 1 || c.maxSuggestItems > 10) &&
                          (c.maxSuggestItems = 10)),
                (c.windowHeightAvailableForSuggest =
                    45 * c.maxSuggestItems + 50),
                c.theme)
            ) {
